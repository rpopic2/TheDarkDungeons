public record NewItem(string name, Skill[] skills)
{
    public static readonly NewItem bardHand = new("(맨손)", new Skill[] {
        new("주먹질", TokenType.Offence, Stats.Sol, "주먹을 휘둘렀다."),
        new("구르기", TokenType.Defence, Stats.Lun, "옆으로 굴렀다.")
        });
    public static readonly NewItem sword = new("(검)", new Skill[] {
