...
public partial class Fightable
{
    ...
    public static readonly Item bareHand = new("맨손", ItemType.Equip, new Skill[] {
        new("주먹질", StanceName.Offence, TokenType.Offence, StatName.Sol, DamageType.Normal, "은 주먹을 휘둘렀다.", (i)=>i.Fire(1)),
    ...
    public static readonly Item shield = new("방패", ItemType.Equip, new Skill[]{
        new("방패밀기", StanceName.Offence, TokenType.Offence, StatName.Sol, DamageType.Normal, "은 방패를 앞으로 세게 밀쳤다.", (i)=>i.Fire(1)),
    ...
    public static readonly Item batItem = new("박쥐", ItemType.Equip, new Skill[] {
        new("들이박기", StanceName.Offence, TokenType.Offence, StatName.Lun, DamageType.Normal, "는 갑자기 당신의 얼굴로 날아들어 부딪혔다!", (i)=>{i.Fire(1); i.Hp -= 1;}),
