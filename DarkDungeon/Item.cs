...
public partial class Creature
{
    ...
    public static readonly ItemOld bareHand = new("맨손", ItemType.Equip, new Skill[] {
    ...
    public static readonly ItemOld sword = new("검", ItemType.Equip, new Skill[] {
    ...
    public static readonly ItemOld dagger = new("단검", ItemType.Equip, new Skill[] {
    ...
    public static readonly ItemOld bow = new("활", ItemType.Equip, new Skill[] {
        new("쏘기", StanceName.Offence, StatName.Lun, DamageType.Thrust, "은 활시위를 당겼다가 놓았다.", (i)=>i.Throw(3, arrow!))});
    public static readonly ItemOld shield = new("방패", ItemType.Equip, new Skill[]{
    ...
    public static readonly ItemOld batItem = new("박쥐의 날개", ItemType.Equip, new Skill[] {
