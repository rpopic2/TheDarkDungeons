...
public partial class Creature
{
    ...
    public static readonly ItemOld ratItem = new("쥐의 이빨", ItemType.Equip, new IBehaviour[]{
            bite, new SkillOld("돌진", StanceName.Offence, StatName.Sol, DamageType.Normal, "는 찍찍 소리를 내며 거대한 이빨을 드러내고 있다. 쥐가 달려든다!", (i)=>{i.Dash(new Position(2, i.Pos.facing));i.Attack(2);i._lastHit?.CurAction.SetStun(1);})
            });
