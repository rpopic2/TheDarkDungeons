...
public partial class Creature
{
    ...
    public static readonly ItemOld spiritStaff = new("정령 깃든 나뭇가지", ItemType.Equip, new IBehaviour[] {
    ...
    public static readonly ItemOld ratItem = new("쥐의 이빨", ItemType.Equip, new IBehaviour[]{
            bite, new SkillOld("돌진", StanceName.Offence, StatName.Sol, DamageType.Normal, "는 찍찍 소리를 내더니 거대한 이빨을 드러내며 달려었다!", (i)=>{i.Dash(new Position(2, i.Pos.facing));i.LastHit?.CurAction.SetStun(1);})
            });
