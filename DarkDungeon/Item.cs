...
public partial class Inventoriable
{
    ...
    public static readonly Item staff = new("(지팡이)", ItemType.Equip, new Skill[] {
        new("휘두르기", TokenType.Offence, StatName.Sol, "은 지팡이를 휘둘렀다.", (i)=>i.Throw(1)),
        new("별빛부름", TokenType.Charge, StatName.Con, "은 신비한 별빛을 불러내어 지팡이를 휘감았다.", (i)=>{})
        });
    ...
    public static readonly Item batItem = new("(박쥐)", ItemType.Equip, new Skill[] {
        ...
        new("구르기", TokenType.Defence, StatName.Lun, "는 가벼운 날개짓으로 옆으로 피했다.", (i)=>i.Dodge())
        });
